...
(test-equal (irregex-search '(- alpha ("aeiouAEIOU")) test-string)
    (irregex-search '(- (/"azAZ") ("aeiouAEIOU")) test-string))

(test-equal (irregex-search '(- (/"azAZ") ("aeiouAEIOU")) test-string)
    (irregex-search '(- alpha ("aeiou") ("AEIOU")) test-string))

(test-equal (irregex-search '(- alpha ("aeiou") ("AEIOU")) test-string)
    (irregex-search '(w/nocase (- alpha ("aeiou"))) test-string))

(test-equal (irregex-search '(w/nocase (- alpha ("aeiou"))) test-string)
    (irregex-search '(w/nocase (- (/ "az") ("aeiou"))) test-string))

(test-equal (irregex-search '(or upper ("aeiou") digit) "xxx A yyy")
    (irregex-search '(or (/ "AZ09") ("aeiou")) "xxx A yyy"))
(test-equal (irregex-search '(or upper ("aeiou") digit) "xxx a yyy")
    (irregex-search '(or (/ "AZ09") ("aeiou")) "xxx a yyy"))
(test-equal (irregex-search '(or upper ("aeiou") digit) "xxx 6 yyy")
...
(test-equal (irregex-search (rx ("abcde")) test-string)
...
(test-equal (irregex-search (rx (or "erstellt." "xxx")) test-string)
...
(test-equal (irregex-search (rx ("abcd")) test-string)
    (irregex-search (rx (or #\a #\b #\c #\d)) test-string))
(test-equal (irregex-search (rx ("xy")) test-string)
...
(test-equal "2"
    (irregex-match-substring (irregex-search (rx (/ "0" #\9)) test-string)))
(test-equal (irregex-search (rx lower-case) test-string)
    (irregex-search (rx (- alphabetic upper-case)) test-string))
(test-equal (irregex-search (rx upper-case) test-string)
...
(let ((str "I am feeding the goose, you are feeding the geese.")
      (me 1)
      (you 2))
  (test-equal "feeding the goose"
      (irregex-match-substring
       (irregex-search (rx (: "feeding the " ,(if (> me 1) "geese" "goose")))
                       str)))
  (test-equal "feeding the geese"
      (irregex-match-substring
...
(let ((kill-matches (lambda (re s)
  ...
  (test-equal " will disappear, also  and "
